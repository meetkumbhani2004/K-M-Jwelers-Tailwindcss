  ...
  return (
    <div className='Header-home'>
      <div className={`Header ${showSearch ? 'blurred' : ''}`}>
        <header className="emillia-header1">
              {/* Top Info Bar */}
          <div className="top-bar animate-in">
            <div className="left-info">
              <span className="hover-pink">
            ...
            <div className="center-info">
              <p>WORLDWIDE SHIPPING - FREE SHIPPING ON ORDERS OVER $100</p>
            </div>
            <div className="right-info">
              <p>🔥 Limited Time Offer! -35% on Selected Items!</p>
            </div>
          </div>
          <nav className="nav-bar">
            ...
            <div className="nav-right-labeled">
              ...
              <PiStarThin className="cart-icon" onClick={() => navigate('/whislist')} />
              <div className="cart-icon-wrapper" onClick={() => navigate('/whislist')}>
                <span className='text-h'>Wishlist</span>
                {totalWishlistItems > 0 && (
                  <span className="cart-count-badge1">{totalWishlistItems}</span>
                )}
              </div>

              <IoBagHandleOutline className="cart-icon1" onClick={() => navigate('/cart')} />
        ...
        {showMobileDrawer && (
          <div className="mobile-drawer">
            <div className="drawer-header">
              <button onClick={() => setShowMobileDrawer(false)}>&times;</button>
            </div>
