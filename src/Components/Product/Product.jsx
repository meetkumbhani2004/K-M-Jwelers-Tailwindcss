...
//allproduct
import {allProducts} from '../../features/product/allproductdata'; 
        ...
        <div className="product-page">
          <div className={`sidebar ${showMobileFilter ? 'show' : ''}`}>
            <div className="sidebar-header">
              ...
              <h4>Category</h4>
              <button className="Category" onClick={() => navigate('/Bracelets')}>Bracelets</button><br />
              <button className="Category" onClick={() => navigate('/Charmjweler')}>Charm Jweler</button><br />
              <button className="Category" onClick={() => navigate('/Necklace')}>Necklace</button><br />
              <button className="Category" onClick={() => navigate('/Pendant')}>Pendant</button><br />
              <button className="Category" onClick={() => navigate('/Rings')}>Rings</button>
